...
import { PRIMARY_MENU_SIDEBAR, SECONDARY_MENU_SIDEBAR } from "@/config";
import { useMenus } from "@/providers";
import { useLayout } from "@/providers";
import { deepMerge } from "@/utils";
import { Demo6LayoutConfig } from ".";
import { SETTING_MENU_SIDEBAR } from "../../config/menu.config";
...
const Demo6LayoutProvider = ({ children }) => {
  ...
  setMenuConfig("primary", PRIMARY_MENU_SIDEBAR);
  setMenuConfig("secondary", SECONDARY_MENU_SIDEBAR);
  setMenuConfig("settings", SETTING_MENU_SIDEBAR);
