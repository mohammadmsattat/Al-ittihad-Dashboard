      ...
      return (
        <Fragment key={index}>
          <MenuItem toggle="accordion" trigger="click" open={true}>
            <MenuLabel className="flex items-center justify-around">
              <MenuToggle className="cursor-pointer pb-2 pt-3 ps-[10.5px] rounded-md border border-transparent">
                <MenuArrow className="me-2.5">
                  <KeenIcon
                    icon="chart-pie-3"
                    className="text-lg menu-item-show:hidden text-gray-500"
                  />
                  <KeenIcon
                    icon="chart-pie-3"
