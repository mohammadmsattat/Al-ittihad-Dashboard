...
const SidebarMenuPrimary = ({ type }) => {
  ...
  const getMenuType = (type) => {
    switch (type) {
      case "main_menu":
        return getMenuConfig("primary");
      case "modules":
        return getMenuConfig("secondary");
      case "settings":
        return getMenuConfig("settings");
      default:
        return getMenuConfig("primary"); // Default menu
    }
  };
