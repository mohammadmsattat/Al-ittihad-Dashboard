      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <InputField label="Name (English)" name="nameEN" value={formData.nameEN} error={errors.nameEN} onChange={handleChange} />
            ...
            <InputField label="Number" name="number" value={formData.number} onChange={handleChange} type="number" />
            <InputField label="Age Group" name="ageGroup" value={formData.ageGroup} onChange={handleChange} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <TextAreaField label="نبذة (عربي)" name="bioAR" value={formData.bioAR} onChange={handleChange} />
            <TextAreaField label="Bio (English)" name="bioEN" value={formData.bioEN} onChange={handleChange} />
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 gap-5 pt-2">
            {["appearances", "goals", "assists", "yellowCards", "redCards"].map((statKey) => (
              <InputField
                key={statKey}
